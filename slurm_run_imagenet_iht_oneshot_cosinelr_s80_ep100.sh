...
#SBATCH --time=60
#SBATCH --mem=200GB
#or srun  -J "imgnet" -c 40 -p gpu -G 2 -o joblog/slurm_run_imagenet_iht_oneshot_cosinelr_s80_ep100.txt -e joblog/slurm_run_imagenet_iht_oneshot_cosinelr_s80_ep100.txt --account=p490-24-t --time=60 --mem=200GB slurm_run_imagenet_iht_oneshot_cosinelr_s80_ep100.sh
